...
const Main = ({ user, working ,handleSwitchChange,switchState,settingWorkingStatus,changeImage}: MainPageType) => {
  return (
    <div className="nflex ngap-[40px]">
      <UserMain user={user} handleSwitchChange={handleSwitchChange} changeImage={changeImage} switchState={switchState}  settingWorkingStatus={settingWorkingStatus}/>
