...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "nborder-t nbg-muted/50 nfont-medium [&>tr]:last:nborder-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "nh-12 npx-4 ntext-left nalign-middle ntext-muted-foreground [&:has([role=checkbox])]:npr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "np-4 nalign-middle [&:has([role=checkbox])]:npr-0",
      className
    )}
    {...props}
  />
