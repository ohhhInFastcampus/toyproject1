...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "nh-12 npx-4 ntext-left nalign-middle nfont-medium ntext-muted-foreground [&:has([role=checkbox])]:npr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("np-4 nalign-middle [&:has([role=checkbox])]:npr-0", className)}
    {...props}
  />
))
