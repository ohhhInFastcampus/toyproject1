...
function TodoList() {
  ...
  return (
    <div className="nw-[300px] nflex nitems-center nbg-blue-100 nrounded-xl nshadow-md nborder-2 np-4 nspace-x-4">
      ...
      <div className="nflex-1 nbg-white nrounded-lg np-2">
        <p className="ntext-sm nfont-semibold nml-3">
          11차 멘토링 <br /> 서비스 분석 회의{" "}
        </p>
      </div>
    </div>
  );
